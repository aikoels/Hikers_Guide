...
DELIMITER $$
USE `hikers_guide_to_the_galaxy`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_activities`(IN trailName varchar(255), IN Longitude float, IN Latitude float, IN givenText text)
BEGIN
...
DELIMITER $$
USE `hikers_guide_to_the_galaxy`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_completed_trail`(IN givenUsername varchar(45), IN givenTrailName varchar(255))
BEGIN
...
DELIMITER $$
USE `hikers_guide_to_the_galaxy`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_geocache`(IN Longitude float, IN Latitude float, IN trailName varchar(255), IN username varchar(45), IN givenDesc text)
BEGIN
...
DELIMITER $$
USE `hikers_guide_to_the_galaxy`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_picture`(IN givenPic BLOB, IN username varchar(45), IN Longitude float, IN Latitude float)
BEGIN
...
DELIMITER $$
USE `hikers_guide_to_the_galaxy`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_review`(IN givenUsername varchar(45), IN givenTrailName varchar(255), IN givenReview TEXT, IN givenRating int)
BEGIN
...
DELIMITER $$
USE `hikers_guide_to_the_galaxy`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_trail_head`(IN givenTrailName varchar(255), IN Longitude float, IN Latitude float)
BEGIN
...
DELIMITER $$
USE `hikers_guide_to_the_galaxy`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `remove_trail`(IN givenTrailName varchar(45))
BEGIN
